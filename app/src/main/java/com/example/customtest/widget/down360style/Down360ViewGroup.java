package com.example.customtest.widget.down360style;
...
public class Down360ViewGroup extends RelativeLayout {
    ...
    public Down360ViewGroup(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        down360LoadingView = findViewById(R.id.down_load);
        ...
        stopContinueImg = findViewById(R.id.stop_img);
        ...
        stopContinueImg.setOnClickListener(v -> {
            if (isStop()) {
